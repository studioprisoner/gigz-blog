...
export default function Container(props) {
    ...
    //After mounting, we have access to the teme
    ...
    return (
        <div className='min-h-screen bg-white dark:bg-hero-background'>
            ...
            <div className='flex flex-col justify-center px-8'>
                <nav className='flex items-center justify-between w-full relative max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pt-8 pb-8 sm:pb-16 text-gray-900 bg-gray-50 dark:bg-gray-900/60 dark:text-gray-100'>
            ...
            <main
                id="skip"
                className='felx flex-col justify-center px-8 bg-gray-50 dark:bg-gray-900'
            >
                {children}
                <Footer />
            </main>
